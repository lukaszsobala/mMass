...
class dlgNotation(wx.Dialog):
    ...
    def makeGUI(self):
        ...
        formulaGrid.Add(
            formula_label, (0, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        formulaGrid.Add(self.formula_value, (0, 1), (1, 7), flag=wx.EXPAND)
        formulaGrid.Add(
            theoreticalMZ_label, (1, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        formulaGrid.Add(self.theoreticalMZ_value, (1, 1))
        formulaGrid.Add(
            charge_label, (1, 2), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        ...
        mainSizer.Add(
            formulaBox,
            0,
            wx.EXPAND | wx.CENTER | wx.LEFT | wx.RIGHT | wx.BOTTOM,
            mwx.PANEL_SPACE_MAIN,
        )
        mainSizer.Add(
            buttons, 0, wx.CENTER | wx.LEFT | wx.RIGHT | wx.BOTTOM, mwx.PANEL_SPACE_MAIN
        )
