...
class dlgMascotEditor(wx.Dialog):
    ...
    def makeItemEditor(self):
        ...
        grid.Add(
            itemSearch_label, (0, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemSearch_value, (0, 4), flag=wx.ALIGN_CENTER_VERTICAL)
        grid.Add(
            itemResults_label, (1, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemResults_value, (1, 4), flag=wx.ALIGN_CENTER_VERTICAL)
        grid.Add(
            itemExport_label, (2, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemExport_value, (2, 4), flag=wx.ALIGN_CENTER_VERTICAL)
        grid.Add(
            itemParams_label, (3, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
