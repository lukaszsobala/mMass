...
class dlgModificationsEditor(wx.Dialog):
    ...
    def makeItemEditor(self):
        ...
        grid.Add(
            itemMoMass_label, (2, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemMoMass_value, (2, 4), flag=wx.ALIGN_CENTER_VERTICAL)
        grid.Add(
            itemAvMass_label, (3, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        ...
        for i in self.itemsList.getSelected():
            ...
            if not name in self.used:
                ...
                dlg = mwx.dlgMessage(
                    ...
                    message="Remove the modification from all of your documents first.",
                )
                dlg.ShowModal()
                dlg.Destroy()
