...
def convertImages():
    ...
    for platform in ("mac", "msw", "gtk"):
        ...
        # make commands
        commands = [
            "-f -a -u -i -n Icon16 images/"
            + platform
            + "/icon_16.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -i -n Icon32 images/"
            + platform
            + "/icon_32.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -i -n Icon48 images/"
            + platform
            + "/icon_48.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -i -n Icon128 images/"
            + platform
            + "/icon_128.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -i -n Icon256 images/"
            + platform
            + "/icon_256.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -i -n Icon512 images/"
            + platform
            + "/icon_512.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n IconAbout images/"
            + platform
            + "/icon_about.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n IconError images/"
            + platform
            + "/icon_error.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n IconDlg images/"
            + platform
            + "/icon_dlg.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n Stopper images/"
            + platform
            + "/stopper.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n Cursors images/"
            + platform
            + "/cursors.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n Arrows images/"
            + platform
            + "/arrows.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BgrToolbar images/"
            + platform
            + "/bgr_toolbar.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BgrToolbarNoBorder images/"
            + platform
            + "/bgr_toolbar_noborder.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BgrControlbar images/"
            + platform
            + "/bgr_controlbar.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BgrControlbarBorder images/"
            + platform
            + "/bgr_controlbar_border.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BgrControlbarDouble images/"
            + platform
            + "/bgr_controlbar_double.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BgrBottombar images/"
            + platform
            + "/bgr_bottombar.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BgrPeakEditor images/"
            + platform
            + "/bgr_peakeditor.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BulletsOn images/"
            + platform
            + "/bullets_on.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BulletsOff images/"
            + platform
            + "/bullets_off.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n Tools images/"
            + platform
            + "/tools.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BottombarsOn images/"
            + platform
            + "/bottombars_on.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n BottombarsOff images/"
            + platform
            + "/bottombars_off.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n ToolbarsOn images/"
            + platform
            + "/toolbars_on.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n ToolbarsOff images/"
            + platform
            + "/toolbars_off.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n PtableOn images/"
            + platform
            + "/periodic_table_on.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n PtableOff images/"
            + platform
            + "/periodic_table_off.png images_lib_"
            + platform
            + ".py",
            "-f -a -u -n PtableSel images/"
            + platform
            + "/periodic_table_sel.png images_lib_"
            + platform
            + ".py",
        ]
