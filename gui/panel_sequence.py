...
class panelSequence(wx.Frame, MakeModalMixin):
    ...
    def makeToolbar(self):
        ...
        self.toolbar.Add(
            self.makeModificationsToolbar(panel), 1, wx.ALIGN_CENTER_VERTICAL
        )
    ...
    def makeSequenceToolbar(self, panel):
        ...
        self.sequenceType_choice = wx.Choice(
            panel,
            -1,
    ...
    def makeModificationsToolbar(self, panel):
        ...
        self.modsSpecifity_check = wx.CheckBox(
            panel, -1, "Show specific modifications only"
        )
    ...
    def makeDigestToolbar(self, panel):
        ...
        self.digestMaxCharge_value = wx.TextCtrl(
            panel,
            -1,
        ...
        sizer.Add(
            self.digestMassTypeMo_radio, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
    ...
    def makeFragmentToolbar(self, panel):
        ...
        self.fragmentMassTypeMo_radio = wx.RadioButton(
            panel, -1, "Mo", style=wx.RB_GROUP
        )
        ...
        self.fragmentMaxCharge_value = wx.TextCtrl(
            panel,
            -1,
        ...
        sizer.Add(
            self.fragmentMassTypeMo_radio, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
        ...
        sizer.AddSpacer(20)
        sizer.Add(
            self.fragmentGenerate_butt, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 10
        )
    ...
    def makeSearchToolbar(self, panel):
        ...
        self.searchMass_value = wx.TextCtrl(
            panel,
            -1,
            "",
            size=(100, -1),
        ...
        self.searchCharge_value = wx.TextCtrl(
            panel,
            -1,
        ...
        sizer.Add(
            self.searchMassTypeMo_radio, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
    ...
    def makeSequencePanel(self):
        ...
        self.sequenceGrid = sequenceGrid(
            ...
            items=config.sequence["editor"]["gridSize"],
        )
        ...
        sequenceTitleSizer.Add(
            self.sequenceTitle_value, 1, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 10
        )
        sequenceTitleSizer.Add(
            sequenceAccession_label, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
        ...
        if wx.Platform == "__WXMAC__":
            self.sequenceEditorSizer.Add(
                sequenceTitleSizer, 0, wx.EXPAND | wx.ALL, mwx.PANEL_SPACE_MAIN
            )
        else:
            self.sequenceEditorSizer.Add(
                sequenceTitleSizer,
    ...
    def makeModificationsPanel(self):
        ...
        mainSizer.Add(ctrlPanel, 0, wx.EXPAND)
        mainSizer.Add(
            self.modificationsList, 1, wx.EXPAND | wx.ALL, mwx.LISTCTRL_NO_SPACE
        )
    ...
    def makeDigestPanel(self):
        ...
        self.digestMiscl_value = wx.TextCtrl(
            ctrlPanel,
            -1,
        ...
        self.digestLowMass_value = wx.TextCtrl(
            ctrlPanel,
            -1,
        ...
        self.digestHighMass_value = wx.TextCtrl(
            ctrlPanel,
            -1,
        ...
        controls.Add(
            self.digestLowMass_value, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
    ...
    def makeFragmentPanel(self):
        ...
        self.fragmentLossNH3_check.SetValue(
            config.sequence["fragment"]["fragments"].count("-NH3")
        )

        self.fragmentLossCO_check = wx.CheckBox(ctrlPanel, -1, "-CO")
        self.fragmentLossCO_check.SetFont(wx.SMALL_FONT)
        self.fragmentLossCO_check.SetValue(
        ...
        self.fragmentLossH3PO4_check.SetValue(
            config.sequence["fragment"]["fragments"].count("-H3PO4")
        )
        ...
        self.fragmentLossDefined_check.SetValue(
        ...
        self.fragmentLossCombi_check.SetValue(
            config.sequence["fragment"]["fragments"].count("losscombi")
        )
        ...
        self.fragmentGainCO_check.SetValue(
            config.sequence["fragment"]["fragments"].count("+CO")
        )
        ...
        self.fragmentScrambling_check.SetValue(
        ...
        self.fragmentRemoveFiltered_check = wx.CheckBox(
            ctrlPanel, -1, "Remove filtered"
        )
        self.fragmentRemoveFiltered_check.SetFont(wx.SMALL_FONT)
        self.fragmentRemoveFiltered_check.SetValue(
            config.sequence["fragment"]["filterFragments"]
        )
    ...
    def makeSearchPanel(self):
        ...
        self.searchTolerance_value = wx.TextCtrl(
            ctrlPanel,
            -1,
        ...
        self.searchUnitsDa_radio = wx.RadioButton(
            ctrlPanel, -1, "Da", style=wx.RB_GROUP
        )
        ...
        self.searchSemiSpecific_check = wx.CheckBox(
            ctrlPanel, -1, "Semi-specific enzyme"
        )
        self.searchSemiSpecific_check.SetFont(wx.SMALL_FONT)
        self.searchSemiSpecific_check.SetValue(
            config.sequence["search"]["semiSpecific"]
        )
        ...
        controls.Add(
            self.searchTolerance_value, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
        controls.Add(
            self.searchUnitsDa_radio, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
    ...
    def onToolSelected(self, evt=None, tool=None):
        ...
        if tool == "editor":
            ...
            self.modifications_butt.SetBitmapLabel(
                images.lib["sequenceModificationsOn"]
            )
            self.toolbar.Show(2)
    ...
    def onAddModification(self, evt):
        ...
        if self.checkModifications(
            self.currentSequence,
            [modification, amino, modtype],
    ...
    def onItemSendToMassCalculator(self, evt):
        ...
        self.parent.onToolsMassCalculator(
            formula=formula, charge=charge, agentFormula="H", agentCharge=1
        )
    ...
    def getParams(self):
        ...
        try:
            ...
            if self.currentTool == "digest":
                ...
                config.sequence["digest"]["maxCharge"] = int(
                    self.digestMaxCharge_value.GetValue()
                )
                config.sequence["digest"]["massType"] = 0
                if self.digestMassTypeAv_radio.GetValue():
                    config.sequence["digest"]["massType"] = 1

                config.sequence["digest"][
                    "enzyme"
                ] = self.digestEnzyme_choice.GetStringSelection()
                config.sequence["digest"]["miscl"] = int(
                    self.digestMiscl_value.GetValue()
                )
                config.sequence["digest"]["lowMass"] = int(
                    self.digestLowMass_value.GetValue()
                )
                config.sequence["digest"]["highMass"] = int(
                    self.digestHighMass_value.GetValue()
                )
            ...
            # fragments
                ...
                config.sequence["fragment"]["maxCharge"] = int(
                    self.fragmentMaxCharge_value.GetValue()
                )
            ...
            # search
                ...
                config.sequence["search"]["mass"] = float(
                    self.searchMass_value.GetValue()
                )

                config.sequence["search"]["charge"] = int(
                    self.searchCharge_value.GetValue()
                )
                config.sequence["search"]["massType"] = 0
                if self.searchMassTypeAv_radio.GetValue():
                    config.sequence["search"]["massType"] = 1

                config.sequence["search"][
                    "enzyme"
                ] = self.searchEnzyme_choice.GetStringSelection()
                config.sequence["search"][
                    "semiSpecific"
                ] = self.searchSemiSpecific_check.GetValue()

                config.sequence["search"]["tolerance"] = float(
                    self.searchTolerance_value.GetValue()
                )
    ...
    def updateSequenceInfo(self):
        ...
        if len(self.currentSequence) and self.currentSequence.chainType == "aminoacids":
            ...
            if selection[0] == selection[1]:
                ...
                label += "     Cursor: %s-%s" % (
                    (selection[0] + 1),
                    min(selection[1], len(self.currentSequence)),
                )
        ...
        if residue:
            for mod in mspy.modifications:
                if (
                    ...
                    or (
                        residue == "N-terminus"
                        and mspy.modifications[mod].termSpecifity == "N"
                    )
                    or (
                        residue == "C-terminus"
                        and mspy.modifications[mod].termSpecifity == "C"
                    )
    ...
    def runDigestion(self):
        ...
        try:
            ...
            for peptide in peptides:
                buff += peptide.variations(
                    maxMods=config.sequence["digest"]["maxMods"],
                    position=config.sequence["digest"]["retainPos"],
                    enzyme=enzyme,
                )
            peptides = buff
            ...
            for peptide in peptides:
                for z in range(1, maxCharge):
                    ...
                    if (
                        mz >= config.sequence["digest"]["lowMass"]
                        and mz <= config.sequence["digest"]["highMass"]
                    ):
                        buff.append(
                            [
                                peptide.history,
    ...
    def runFragmentation(self):
        ...
        try:
            ...
            for fragment in fragments:
                buff += fragment.variations(
                    maxMods=config.sequence["fragment"]["maxMods"], position=False
                )
            fragments = buff
            ...
            for fragment in fragments:
                for z in range(1, maxCharge):
                    ...
                    if (
                        not config.sequence["fragment"]["filterFragments"]
                        or not fragment.fragmentFiltered
                    ):
                        buff.append(
                            [
                                fragment.format("f"),
                                fragment.history,
                                fragment.mz(z * polarity)[
                                    config.sequence["fragment"]["massType"]
                                ],
                                z * polarity,
    ...
    def runSearch(self):
        ...
        try:
            ...
            buff = []
            for peptide in peptides:
                mz = peptide.mz(config.sequence["search"]["charge"])[
                    config.sequence["search"]["massType"]
                ]
                buff.append(
                    [
                        peptide.history,
                        ...
                        mspy.delta(
                            mz,
                            config.sequence["search"]["mass"],
                            config.sequence["search"]["units"],
                        ),
                        peptide,
                    ]
                )
    ...
    def checkModifications(self, sequence, modification, maxMods):
        ...
        if modification[1] in ("nTerm", "cTerm"):
            for mod in sequence.modifications:
                if mod[1] == modification[1] and (
                    mod[2] == "f" or modification[2] == "f"
                ):
                    return False
            return True
...
class sequenceCanvas(wx.TextCtrl):
    ...
    def __init__(
        ...
        self.Bind(
            wx.EVT_RIGHT_DOWN, self._onRMU
        )  # wx.EVT_RIGHT_UP does't work on Linux and Mac
...
class sequenceGrid(wx.StaticBoxSizer):
    ...
    def addRow(self):
        ...
        for x in range(5):
            ...
            self.grid.Add(
                label, (row, col), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
            )
