...
class panelDocumentExport(wx.Frame, MakeModalMixin):
    ...
    def makeImagePanel(self):
        ...
        grid.Add(
            imageWidth_label, (0, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid.Add(self.imageWidth_value, (0, 1), flag=wx.ALIGN_CENTER_VERTICAL)
        grid.Add(
            self.imageUnits_choice,
            (0, 2),
            flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT,
        )
        grid.Add(
            imageHeight_label, (1, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
    ...
    def makePeaklistPanel(self):
        ...
        self.peaklistSelect_choice = wx.Choice(
            panel,
            -1,
        ...
        self.peaklistFormat_choice = wx.Choice(
            panel,
            -1,
        ...
        self.peaklistSeparator_choice = wx.Choice(
            panel,
            -1,
        ...
        choices = {",": 0, ";": 1, "tab": 2}
        self.peaklistSeparator_choice.Select(
            choices[config.export["peaklistSeparator"]]
        )
        ...
        grid2.Add(
            peaklistSelect_label, (0, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid2.Add(self.peaklistSelect_choice, (0, 1))
        grid2.Add(
            peaklistFormat_label, (1, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid2.Add(self.peaklistFormat_choice, (1, 1))
        grid2.Add(
            peaklistSeparator_label,
            (2, 0),
            flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT,
        )
    ...
    def makeSpectrumPanel(self):
        ...
        choices = {",": 0, ";": 1, "tab": 2}
        self.spectrumSeparator_choice.Select(
            choices[config.export["spectrumSeparator"]]
        )
    ...
    def onExportPeaklist(self):
        ...
        self.processing = threading.Thread(
            target=self.runExportPeaklist, kwargs={"path": path}
        )
    ...
    def onExportSpectrum(self):
        ...
        # make image
        self.processing = threading.Thread(
            target=self.runExportSpectrum, kwargs={"path": path}
        )
        self.processing.start()
