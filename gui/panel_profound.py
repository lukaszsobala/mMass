...
class panelProfound(wx.Frame):
    ...
    def makePMFPanel(self):
        ...
        self.paramVariableMods_label = wx.StaticText(
        ...
        self.paramPeptideTol_value = wx.TextCtrl(
            panel,
            -1,
        ...
        self.paramMassType_choice = wx.Choice(
            panel,
            -1,
        ...
        # results elements
        self.paramExpectation_radio = wx.RadioButton(
            panel, -1, "Expectation value:", style=wx.RB_GROUP
        )
        self.paramExpectation_value = wx.TextCtrl(
            panel,
            -1,
        ...
        self.paramCandidates_value = wx.TextCtrl(
            panel,
            -1,
        ...
        modsGrid.Add(
            self.paramVariableMods_label, (0, 1), flag=wx.ALIGN_CENTER_VERTICAL
        )
        ...
        massesGrid.Add(
            paramProteinMass_label,
            (0, 0),
            flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL,
        )
        massesGrid.Add(
            self.paramProteinMassLow_value, (0, 1), flag=wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(paramProteinMass_dash, (0, 2), flag=wx.ALIGN_CENTER_VERTICAL)
        massesGrid.Add(
            self.paramProteinMassHigh_value, (0, 3), flag=wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(
            paramProteinMassUnits_label, (0, 4), flag=wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(
            paramProteinPI_label, (1, 0), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(
            self.paramProteinPILow_value, (1, 1), flag=wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(paramProteinPI_dash, (1, 2), flag=wx.ALIGN_CENTER_VERTICAL)
        massesGrid.Add(
            self.paramProteinPIHigh_value, (1, 3), flag=wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(
            paramPeptideTol_label,
            (2, 0),
            flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL,
        )
        massesGrid.Add(
            self.paramPeptideTol_value, (2, 1), flag=wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(
            self.paramPeptideTolUnits_choice,
            (2, 3),
            (1, 2),
            flag=wx.ALIGN_CENTER_VERTICAL,
        )
        massesGrid.Add(
            paramMassType_label, (0, 5), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        massesGrid.Add(self.paramMassType_choice, (0, 6), flag=wx.ALIGN_CENTER_VERTICAL)
        massesGrid.Add(
            paramCharge_label, (1, 5), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        ...
        resultsGrid.Add(
            self.paramExpectation_radio,
            (0, 0),
            flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL,
        )
        resultsGrid.Add(
            self.paramExpectation_value,
            (0, 1),
            flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL,
        )
        resultsGrid.Add(
            self.paramZscore_radio,
            (0, 3),
            flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL,
        )
        resultsGrid.Add(
            self.paramCandidates_value,
            (0, 4),
            flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL,
        )
    ...
    def getParams(self):
        ...
        try:
            ...
            if config.profound["proteinMassLow"]:
                config.profound["proteinMassLow"] = float(
                    config.profound["proteinMassLow"]
                )

            if config.profound["proteinMassHigh"]:
                config.profound["proteinMassHigh"] = float(
                    config.profound["proteinMassHigh"]
                )
            ...
            if config.profound["proteinPIHigh"]:
                config.profound["proteinPIHigh"] = float(
    ...
    def updateForm(self):
        ...
        if config.profound["taxonomy"] in self.currentParams["SPEC"]:
            self.paramTaxonomy_choice.Select(
                self.currentParams["SPEC"].index(config.profound["taxonomy"])
            )
