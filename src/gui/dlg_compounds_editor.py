...
class dlgCompoundsEditor(wx.Dialog):
    ...
    def makeItemEditor(self):
        ...
        grid.Add(
            itemFormula_label, (2, 0), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemFormula_value, (2, 1), flag=wx.ALIGN_CENTER_VERTICAL)

        grid.Add(
            itemMoMass_label, (0, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemMoMass_value, (0, 4), flag=wx.ALIGN_CENTER_VERTICAL)
        grid.Add(
            itemAvMass_label, (1, 3), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
