...
class dlgEnzymesEditor(wx.Dialog):
    ...
    def makeItemEditor(self):
        ...
        grid.Add(
            itemExpression_label, (1, 0), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemExpression_value, (1, 1), flag=wx.ALIGN_CENTER_VERTICAL)

        grid.Add(
            itemCTerm_label, (2, 0), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemCTerm_value, (2, 1), flag=wx.ALIGN_CENTER_VERTICAL)
        grid.Add(
            itemNTerm_label, (3, 0), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.itemNTerm_value, (3, 1), flag=wx.ALIGN_CENTER_VERTICAL)

        grid.Add(
            self.itemModsBefore_check,
            (0, 3),
            flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL,
        )
        grid.Add(
            self.itemModsAfter_check,
            (1, 3),
            flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL,
        )
    ...
    def onAddItem(self, evt):
        ...
        if itemData.name in mspy.enzymes:
            wx.Bell()
            title = (
                "Enzyme with the same name already exists.\nDo you want to replace it?"
            )
