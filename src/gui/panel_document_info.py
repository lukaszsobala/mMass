...
class panelDocumentInfo(wx.Frame):
    ...
    def makeSummaryPanel(self):
        ...
        grid.Add(
            institution_label, (3, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid.Add(self.institution_value, (3, 1))
        grid.Add(
            instrument_label, (4, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
    ...
    def makeSpectrumPanel(self):
        ...
        grid = wx.GridBagSizer(mwx.GRIDBAG_VSPACE, mwx.GRIDBAG_HSPACE)
        grid.Add(
            scanNumber_label, (0, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid.Add(self.scanNumber_value, (0, 1))
        grid.Add(
            retentionTime_label, (1, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        ...
        grid.Add(
            precursorMZ_label, (3, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid.Add(self.precursorMZ_value, (3, 1))
        grid.Add(
            precursorCharge_label,
            (4, 0),
    ...
    def onPresetsSave(self, evt):
        ...
        libs.presets["operator"][name][
            "institution"
        ] = self.institution_value.GetValue()
    ...
    def setData(self, document):
        ...
        if self.currentDocument:
            ...
            if document.spectrum.retentionTime is not None:
                self.retentionTime_value.ChangeValue(
                    str(document.spectrum.retentionTime)
                )
            ...
            if document.spectrum.precursorCharge is not None:
                self.precursorCharge_value.ChangeValue(
                    str(document.spectrum.precursorCharge)
                )
