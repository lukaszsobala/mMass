...
class panelMassCalculator(wx.Frame):
    ...
    def makeSummaryPanel(self):
        ...
        grid.Add(
            summaryFormula_label, (0, 0), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
        grid.Add(self.summaryFormula_value, (0, 1))
        grid.Add(
            summaryMono_label, (1, 0), flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL
        )
    ...
    def makeIonseriesPanel(self):
        ...
        self.ionseriesPositive_radio = wx.RadioButton(
            ctrlPanel, -1, "Positive", style=wx.RB_GROUP
        )
        ...
        controls.Add(
            ionseriesAgentCharge_label, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
        ...
        controls.Add(
            self.ionseriesPositive_radio, 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5
        )
    ...
    def makePatternCanvas(self):
        ...
        self.patternCanvas.setProperties(showXPosBar=False)
        self.patternCanvas.setProperties(showYPosBar=False)
        ...
        self.patternCanvas.setProperties(
    ...
    def runIonSeries(self):
        ...
        try:
            ...
            while True:
                ...
                charge = (
                    i
                    * config.massCalculator["ionseriesPolarity"]
                    * abs(config.massCalculator["ionseriesAgentCharge"])
                )
    ...
    def makeProfile(self):
        ...
        scale = (
            config.massCalculator["patternIntensity"]
        ...
        for isotope in mspy.maxima(self.currentPatternProfile):
            mz = isotope[0]
            centroid = mspy.centroid(
                self.currentPatternProfile, isotope[0], isotope[1] * 0.99
            )
