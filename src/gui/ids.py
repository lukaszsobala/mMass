...
ID_documentOpenBruker = wx.NewId()
...
ID_documentRulersAutoText = wx.NewId()
ID_documentRulerShow = wx.NewId()
ID_documentRulerEdit = wx.NewId()
ID_documentRulerDelete = wx.NewId()
...
ID_toolsDiffRulerSettings = wx.NewId()
